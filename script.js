...
function crearAnimaciones() {
    for (let i = 0; i < 20; i++) {
        ...
        cat.style.backgroundImage = 'url("https://cdn-icons-png.freepik.com/256/6988/6988878.png?semt=ais_hybrid")'; // URL de la primera imagen de gatito
        ...
        cat2.style.backgroundImage = 'url("https://cdn.icon-icons.com/icons2/2787/PNG/512/black_cat_icon_177458.png")'; // URL de la segunda imagen de gatito
